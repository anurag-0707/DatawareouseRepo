...
public class ProductResultDTO implements Serializable {
	...
	public ProductResultDTO(int productId, String productName, float productPrice, int productQuantity,
	...
	public String toString() {
		return "ProductResultDTO [productId=" + productId + ", productName=" + productName + ", productPrice="
				+ productPrice + ", productQuantity=" + productQuantity + ", productManufacturedDate="
				+ productManufacturedDate + ", productExpiryDate=" + productExpiryDate + "]";
	}
